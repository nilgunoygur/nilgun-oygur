...
export function LinkCourseForm() {
  ...
  return <form action={action}>
    <FieldGroup>
      <Field><FieldLabel htmlFor="shopierLink">Shopier ürün linki</FieldLabel><Input id="shopierLink" name="shopierLink" required placeholder="https://www.shopier.com/51075042" /><FieldDescription>Mağazada gizli ürünler için. Mağazadaki dijital ürünler otomatik eklenir.</FieldDescription></Field>
