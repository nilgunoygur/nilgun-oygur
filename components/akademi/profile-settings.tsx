...
export function ProfileSettings({ user, localEmail }: { user: { name: string; email: string; image?: string | null }; localEmail: boolean }) {
  ...
  return <div className="grid gap-8">
    ...
    <form className={accountCard} onSubmit={async (event) => {
      ...
      <FieldGroup><div className="mb-2"><h2 className="text-2xl font-semibold text-forest">Şifrenizi değiştirin</h2><p className="mt-2 text-sm text-stone">Hesabınızı güvende tutmak için güçlü bir şifre seçin.</p></div>
