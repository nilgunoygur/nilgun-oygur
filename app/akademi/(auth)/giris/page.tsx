...
export default async function Page({ searchParams }: { searchParams: Promise<Record<string, string | string[] | undefined>> }) {
  ...
  return <AuthShell title="Yeniden merhaba." description="Eğitimlerinize devam etmek için hesabınıza giriş yapın."><AuthForm mode="login" configured={isAuthConfigured()} token={typeof params.token === "string" ? params.token : undefined} destination={typeof params.next === "string" ? params.next : undefined} initialMessage={message} /></AuthShell>;
}
