...
export default async function Page({ searchParams }: { searchParams: Promise<Record<string, string | string[] | undefined>> }) {
  ...
  return <AuthShell title="İlk adımı atın." description="Hesabınızı oluşturun, öğrenme yolculuğunuz için yerinizi hazırlayın."><AuthForm mode="register" configured={isAuthConfigured()} token={typeof params.token === "string" ? params.token : undefined} destination={typeof params.next === "string" ? params.next : undefined} initialMessage={message} /></AuthShell>;
}
